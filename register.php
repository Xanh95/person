                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12 form bg-r">
                        <form id="register" method="post" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <input type="text" class="form-control" value="<?php echo isset($_POST['phone']) ? $_POST['phone'] : ''; ?>" id="phone" placeholder="Enter phone" name="phone">
                            </div>
                            <div>
                                <label for="birthday">Ngày tháng nắm sinh:</label>
                                <input type="text" class="form-control" value="<?php echo isset($_POST['birthday']) ? $_POST['birthday'] : ''; ?>" id="birthday" placeholder="ngày/tháng/năm" name="birthday">
                            </div>
                            <div>
                                <label for="address">Địa chỉ:</label>
                                <input type="text" class="form-control" value="<?php echo isset($_POST['address']) ? $_POST['address'] : ''; ?>" id="address" placeholder="Enter address" name="address">

                            </div>
                            <div>
                                <label for="email">Email address</label>
                                <input type="text" class="form-control" value="<?php echo isset($_POST['email']) ? $_POST['email'] : ''; ?>" id="email" placeholder="Enter email" name="email">
                                <label id="name-error" class="error" for="name"><?php echo isset($errors["usedemail"]) ? $errors["usedemail"] : ''; ?></label>
                            ...
                            <div>
                                ...
                                <label id="name-error" class="error" for="avatar"><?php echo empty($error) ? '' : $error; ?></label>
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" <?php echo $checked_male; ?> name="gender" value="0"> Nam
                                <input class='gender' type="radio" class="form-check-input" <?php echo $checked_female; ?> name="gender" value="1">Nữ
                                <p class="error">
                                    <?php echo isset($error['gender']) ? $error['gender'] : ''; ?></p>
                            </div>
